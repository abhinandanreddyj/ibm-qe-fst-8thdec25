...
public class Activity9 {
    ...
    public void simpleAlertTestCase() {
        ...
        By simpleAlertLocator = By.id("simple");
        driver.findElement(simpleAlertLocator).click();
    ...
    public void promptAlertTestCase() {
        ...
        // Click the button to open a simple alert
        By promptAlertLocator = By.id("prompt");
        driver.findElement(promptAlertLocator).click();
